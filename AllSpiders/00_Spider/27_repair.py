...
class douyu(unittest.TestCase):
    # 初始化方法，必须是setUp()
    def setUp(self):
        self.driver = webdriver.PhantomJS(executable_path=r'E:\Documents\Apps\phantomjs-2.1.1-windows\bin\phantomjs.exe')
        self.num = 0
        self.count = 0
    ...
    def testDouyu(self):
        ...
        while True:
            ...
            # 房间名, 返回列表
            self.driver.save_screenshot("27_repair1.png")
            ...
            for name, number in zip(names, numbers):
                print u"房间名: " + name.get_text().strip() + u"\t观众人数: -" + number.get_text().strip()
                self.num += 1
